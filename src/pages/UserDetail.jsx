              ...
              <button className="flex items-center justify-center w-full py-3 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 transition duration-150 space-x-2">
                ...
                >
                  <path
                    ...
                    strokeWidth="2"
                    d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.54A9.732 9.732 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
                  ></path>
                </svg>
